...
public class AddBookCommand implements Command, Serializable {
	...
	public void execute(InventoryImpl inventory) {
		...
		// in above line we have called this method from inventorydecorator and this
		// call goes to inventoryImpl,
		// which will add book to this inventory (and write the inventory memento if
		// needed and delete the command file) and then
